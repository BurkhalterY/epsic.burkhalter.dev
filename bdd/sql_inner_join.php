...
INNER JOIN t_email ON fk_email = id_email</code></pre>
	<p>On peut bien évidement ajouté les même options supplémentaires qu'<a href="sql_select.php">ici</a>. Simplement les rajouter à la fin.</p>
	
	<p>La base de données utilisée est disponible <a href="medias/tuto.sql">ici</a>.</p>

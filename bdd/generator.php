<?php
	$title = 'Générateur de site Python tout fait';
	include 'header.php';
?>
...
Ne cocher qu'une seule case ID par table. L'id doit être de type int.</pre>
	...
	<?php
		if(isset($_POST['generate'])){
			$time = time();
			include 'generator/php/hello_flask.php';
			include 'generator/php/GestionTables.php';
			include 'generator/php/NOM_PRENOM_SUJET_BD_104.php';
			include 'generator/php/Templates/PagePrincipaleHome.php';
			include 'generator/php/Templates/tables/TablesAfficher.php';
			include 'generator/php/Templates/tables/TablesAdd.php';
			include 'generator/php/Templates/tables/TablesEdit.php';
			include 'generator/php/Templates/tables/TablesDelete.php';
			include 'generator/php/_copy.php';
			include 'generator/php/zip.php';

			echo '<a href="generator/output/'.$time.'.zip">Télécharger en ZIP</a>';;
		}
	?>

...
?>
	...
	<img src="medias/RJ-45_droit.png" alt="Câblage droit" style="max-width: 100%; border: 1px solid black;" />
	<p><strong>Câblage croisé :</strong></p>
	<img src="medias/RJ-45_croise.png" alt="Câblage croisé" style="max-width: 100%; border: 1px solid black;" />
	<br><br>

	<h3>Fibre optique</h3>
	<img src="medias/fibre_optique_schema.png" alt="Schéma fibre optique" style="max-width: 100%;" />
	<hr>
	<img src="medias/fibre_optique_comp.png" alt="Comparaison fibre optique" style="max-width: 100%;" />

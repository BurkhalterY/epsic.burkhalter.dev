...
# OM 2019.03.25 on doit importer le module films définit grâce à "blueprint"
# cela allège le fichier principal
from GestionFilms import films

# OM 2019.04.06 on doit importer le module GestionFilmsGenres définit grâce à "blueprint"
from GestionFilmsGenres import filmsgenres

# OM 2019.03.25 on doit importer le module genres définit grâce à "blueprint"
from GestionGenres import genres
...
# OM 2019.04.06 Tout ce qui concerne les films va commencer par la chaîne de caractère "filmsGenres"
app.register_blueprint(filmsgenres, url_prefix='/filmsGenres')

# OM 2019.03.25 Tout ce qui concerne les films va commencer par la chaîne de caractère "films"
app.register_blueprint(films, url_prefix='/films')

# OM 2019.03.25 Chaque chemin qui concerne les genres des films va commencer par la chaîne de caractère "genres"

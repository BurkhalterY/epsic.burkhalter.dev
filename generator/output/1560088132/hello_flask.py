...
# OM 2019.03.25 on doit importer le module s définit grâce à "blueprint"
# cela allège le fichier principal
from Gestions import s
...
# OM 2019.03.25 Tout ce qui concerne les s va commencer par la chaîne de caractère "s"

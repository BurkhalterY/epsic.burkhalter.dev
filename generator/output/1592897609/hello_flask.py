...
# OM 2019.03.25 on doit importer le module insultes définit grâce à "blueprint"
# cela allège le fichier principal
from GestionInsultes import insultes
...
# OM 2019.03.25 Tout ce qui concerne les insultes va commencer par la chaîne de caractère "insultes"
app.register_blueprint(insultes, url_prefix='/insultes')

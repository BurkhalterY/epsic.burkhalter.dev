...
--
-- Structure de la table `t_insultes`
--

CREATE TABLE `t_insultes` (
  `id` int(11) NOT NULL,
  `nom_de_l_insulte` varchar(255) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
--
-- Index pour la table `t_insultes`
--
ALTER TABLE `t_insultes`
  ADD PRIMARY KEY (`id`);

--
-- AUTO_INCREMENT pour la table `t_insultes`
--
ALTER TABLE `t_insultes`

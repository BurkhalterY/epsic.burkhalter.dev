...
# OM 2019.03.25 on doit importer le module tests définit grâce à "blueprint"
# cela allège le fichier principal
from GestionTests import tests
...
# OM 2019.03.25 Tout ce qui concerne les tests va commencer par la chaîne de caractère "tests"

...
# OM 2019.03.25 on doit importer le module types définit grâce à "blueprint"
# cela allège le fichier principal
from GestionTypes import types
...
# OM 2019.03.25 Tout ce qui concerne les types va commencer par la chaîne de caractère "types"

...
?>
	...
	<p>Les fonctions logiques sont les seules opérations qu'un processeur peut effectuer. Il les combinent ensuite pour en faire des plus complexes tel que l'addition, multiplication, etc...</p>

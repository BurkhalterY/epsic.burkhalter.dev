<template>
	<div>
		...
		<pre class="language-java"><ShowCode file="poo/interfaces0.java" lang="java"/></pre>
		<p>Utilisation d'une interface dans une classe :</p>
		<pre class="language-java"><ShowCode file="poo/interfaces1.java" lang="java"/></pre>
		<br>
		...
		<pre class="language-java"><ShowCode file="poo/interfaces2.java" lang="java"/></pre>
		...
		<pre class="language-java"><ShowCode file="poo/interfaces3.java" lang="java"/></pre>
		<pre class="language-java"><ShowCode file="poo/interfaces4.java" lang="java"/></pre>

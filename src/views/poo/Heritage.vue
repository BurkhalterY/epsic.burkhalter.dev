<template>
	<div>
		...
		<pre class="language-java"><ShowCode file="poo/heritage0.java" lang="java"/></pre>
		...
		<pre class="language-java"><ShowCode file="poo/heritage1.java" lang="java"/></pre>
		La classe enfant : Apprenti
		<pre class="language-java"><ShowCode file="poo/heritage2.java" lang="java"/></pre>

<template>
  <div>
    ...
    <p>
      ...
      fonctionnalités. Une caractèristique, c'est par exemple, pour une voiture,
      le nombre de roues ou la vitesse max. Et une fonctionnalité, pour notre
      voiture, ça pourrait être de rouler.
    </p>
    <p>
      En informatique, c'est la même chose. Les caractéristiques (nommées
      attributs) d'une fenêtre seraient sa taille et sa position. Et ses
      fonctionnalités (nommées méthodes) seraient par exemple de l'agrandir avec
      la souris, etc.
    </p>
    ...
    <img
      src="/medias/poo/new_class_1.png"
      alt="Nouvelle classe"
      class="img-fluid"
    />
    <p>
      Donnez un nom à votre classe, par exemple Personne. Les noms des classes
      commencent toujours par une majuscule.
    </p>
    <img
      src="/medias/poo/new_class_2.png"
      alt="Nouvelle classe"
      class="img-fluid"
    />
    ...
    <pre
      class="language-java"
    ><ShowCode file="poo/objet0.java" lang="java"/></pre>

    <h3>Lui ajouter des attributs</h3>
    <p>
      Il suffit pour cela de mettre de noter les attributs comme des variables
      mais sans les initialiser.
    </p>
    <pre
      class="language-java"
    ><ShowCode file="poo/objet1.java" lang="java"/></pre>
    ...
    <pre
      class="language-java"
    ><ShowCode file="poo/objet2.java" lang="java"/></pre>

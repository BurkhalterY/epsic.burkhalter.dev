<template>
  <div>
    ...
    <p>
      <a href="/medias/network/projet_1.pdf" target="_blank">projet_1.pdf</a>
    </p>
    ...
    <p>
      10 + 5 + 5 + 2 = 22<br />22 + 1 (passerelle) = 23<br />23 + 10% =
      <strong>26</strong> (arrondi supérieur)
    </p>
    <h4>Nombre de sous-réseaux</h4>
    <p>
      Le patron prévoit 2 bureaux supplémentaires → 4 sous-réseaux<br />4 + 10%
      = <strong>5</strong>
    </p>
    ...
    <p>
      ln(5 + 2) / ln(2) = ~2.807... → <strong>3</strong><br /><a
        href="/medias/network/ti-30xpro-ln.png"
        target="_blank"
        >Voir sur la calculatrice.</a
      >
    </p>
    <h4>Pour les IP</h4>
    <p>
      n = ln(IP + 2) / ln(2)<br />ln(26 + 2) / ln(2) = ~4.807... →
      <strong>5</strong>
    </p>
    ...
    <p>
      ...
      sous-réseau<br />Si n ≤ 8 → Classe C<br />Si n ≤ 16 → Classe B<br />Si n ≤
      24 → Classe A
    </p>
    ...
    <p>
      Nous avons une adresse constitué de :<br />24 bits pour le réseau<br />3
      bits pour le sous-réseau<br />5 bits pour l'host
    </p>

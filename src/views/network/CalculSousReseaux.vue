<template>
	<div>
		...
		<p><a href="/medias/network/projet_1.pdf" target="_blank">projet_1.pdf</a></p>
		...
		<p>ln(5 + 2) / ln(2) = ~2.807... → <strong>3</strong><br><a href="/medias/network/ti-30xpro-ln.png" target="_blank">Voir sur la calculatrice.</a></p>
		<h4>Pour les IP</h4>

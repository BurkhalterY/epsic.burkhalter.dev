<template>
	<div>
		...
		<img src="/medias/access/icud.png" />
		...
		<img src="/medias/access/icud_c1.png" />
		...
		<img src="/medias/access/icud_c2.png" />
		...
		<pre class="language-visual-basic"><ShowCode file="access/Form_AfterInsert.vba" lang="vba"></ShowCode></pre>
		...
		<pre class="language-visual-basic"><ShowCode file="access/Btn_ajouter_email_Click.vba" lang="vba"></ShowCode></pre>
		...
		<img src="/medias/access/icud_i1.png" />
		<p>Selectionnez T_Email</p>
		<img src="/medias/access/icud_i2.png" />
		<p>Prenez au moins l'ID et l'adresse</p>
		<img src="/medias/access/icud_i3.png" />
		<p>Il n'y a plus grand chose à configurer par la suite, vous pouvez faire suivant, suivant, suivant...</p>
		<img src="/medias/access/icud_i4.png" />
		<img src="/medias/access/icud_i5.png" />
		<img src="/medias/access/icud_i6.png" />
		<img src="/medias/access/icud_i7.png" />
		...
		<pre class="language-visual-basic"><ShowCode file="access/Btn_selectionner_Click.vba" lang="vba"></ShowCode></pre>
		<p>Et, ne pas oublier de donner un évènement au bouton v dans le formulaire F_Personne</p>
		<pre class="language-visual-basic"><ShowCode file="access/Btn_importer_email_Click.vba" lang="vba"></ShowCode></pre>
		...
		<pre class="language-visual-basic"><ShowCode file="access/Btn_supprimer_email_Click.vba" lang="vba"></ShowCode></pre>
		...
		<pre class="language-visual-basic"><ShowCode file="access/Form_AfterUpdate.vba" lang="vba"></ShowCode></pre>
		<p>Il faut aussi mettre un peu de code sur le bouton d'édition :</p>
		<pre class="language-visual-basic"><ShowCode file="access/Btn_modifier_email_Click.vba" lang="vba"></ShowCode></pre>

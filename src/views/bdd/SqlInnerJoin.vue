<template>
	<div>
		...
		<pre class="language-sql"><ShowCode file="bdd/select-1-1.sql" lang="sql"/></pre>
		...
		<pre class="language-sql"><ShowCode file="bdd/select-1-n.sql" lang="sql"/></pre>
		<p>On peut bien évidement ajouté les même options supplémentaires qu'<router-link to="/bdd/sql_select">ici</router-link>. Simplement les rajouter à la fin.</p>

		<p>La base de données utilisée est disponible <a href="/medias/bdd/tuto.sql">ici</a>.</p>
	</div>
</template>

<template>
	<div>
		<h1>Conversion Base64</h1>
		<strong>Valeur :</strong><br>
		<textarea class="w-100" v-model="content" @keyup="toBase64()"></textarea><br>
		<br>
		<strong>Base64 :</strong><br>
		<textarea class="w-100" v-model="base64" @keyup="fromBase64()"></textarea><br>

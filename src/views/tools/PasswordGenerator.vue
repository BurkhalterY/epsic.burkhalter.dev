<template>
  <div>
    ...
    <input type="number" v-model="length" />&nbsp;<span
      title="Pour une longueur supérieure à 32, utiliser ce champ"
      >🛈</span
    ><br />
    <input type="checkbox" id="useLower" v-model="useLower" />&nbsp;<label
      for="useLower"
      >Minuscules</label
    ><br />
    <input type="checkbox" id="useUpper" v-model="useUpper" />&nbsp;<label
      for="useUpper"
      >Majuscules</label
    ><br />
    <input type="checkbox" id="useNumbers" v-model="useNumbers" />&nbsp;<label
      for="useNumbers"
      >Chiffres</label
    ><br />
    <input type="checkbox" id="useSymbols" v-model="useSymbols" />&nbsp;<label
      for="useSymbols"
      >Symboles</label
    ><br />
    <input

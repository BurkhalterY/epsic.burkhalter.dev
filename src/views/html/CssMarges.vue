<template>
	<div>
		...
		<pre class="language-css"><ShowCode file="html/margin-4.css" lang="css"/></pre>
		<pre class="language-css"><ShowCode file="html/margin-3.css" lang="css"/></pre>
		<pre class="language-css"><ShowCode file="html/margin-2.css" lang="css"/></pre>
		<pre class="language-css"><ShowCode file="html/margin-1.css" lang="css"/></pre>

		<p>Il existe aussi les quatre propriétés <code>margin-top</code>, <code>margin-right</code>, <code>margin-bottom</code> et <code>margin-left</code> et leur équivalent en padding pour ne spécifier qu'un côté. Utile lorsque nous aborderons l'<router-link to="/html/css_dom_heritage">héritage</router-link>.</p>
	</div>
</template>

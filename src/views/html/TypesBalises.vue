	...
	<div>
		...
		<table class="table">
			...
			<tr>
				...
				<td><ShowCode class="language-html" inlineCode="<div>" lang="html"/></td>
				<td><ShowCode class="language-html" inlineCode="<span>" lang="html"/></td>
			</tr>
		</table>
		...
		<table class="table">
			...
			<tr>
				<td><ShowCode class="language-html" inlineCode="<span>" lang="html"/></td>
				<td>Inline</td>
				<td>Équivalent de <ShowCode class="language-html" inlineCode="<div>" lang="html"/> en inline.</td>
			</tr>
			<tr>
				<td><ShowCode class="language-html" inlineCode="<p>" lang="html"/></td>
				<td>Block</td>
				<td>Un paragraphe. Pour insérer un retour à la ligne, écrire <ShowCode class="language-html" inlineCode="<br>" lang="html"/>.</td>
			</tr>
			<tr>
				<td><ShowCode class="language-html" inlineCode="<h1>" lang="html"/>, <ShowCode class="language-html" inlineCode="<h2>" lang="html"/> ... <ShowCode class="language-html" inlineCode="<h6>" lang="html"/></td>
				<td>Block</td>

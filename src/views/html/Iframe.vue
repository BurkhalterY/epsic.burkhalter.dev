<template>
	<div>
		...
		<p>L'intégration est une technique qui permet d'insérer une page web complète dans votre site. La page est "encapsulée" dans une frame qui se comportera comme une div. La balise à utiliser et <ShowCode class="language-html" inlineCode="<iframe>" lang="html"/> avec l'attribut <code>src</code>.</p>
		<pre class="language-html"><ShowCode file="html/iframe.html" lang="html"/></pre>

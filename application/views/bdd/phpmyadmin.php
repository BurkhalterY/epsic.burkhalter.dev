...
<img src="<?=base_url('medias/bdd/phpmyadmin_login.png')?>" alt="login()" />
<p>Vous arrivez normalement sur cette page :</p>
<img src="<?=base_url('medias/bdd/phpmyadmin_home.png')?>" alt="Page principale" />

<h3>Créer une nouvelle base de données</h3>
<p><img src="<?=base_url('medias/bdd/danger_icon.png')?>" alt="Attention" width="32" />Ne pas confondre table et base de données. Une base de données correspond aux fichier Access (.accdb) et les tables en font partie.</p>
<p>Pour créer une nouvelle base de données, cliquez Nouvelle base de données sur le menu de droite.</p>
<img src="<?=base_url('medias/bdd/phpmyadmin_new_base.png')?>" alt="Nouvelle base de données" />
<p>Entrez le nom de votre base et laissez l'interclassement par défaut pour l'instant.</p>
<img src="<?=base_url('medias/bdd/phpmyadmin_new_base2.png')?>" alt="Nom de la base de données" />
...
<img src="<?=base_url('medias/bdd/phpmyadmin_new_table.png')?>" alt="Nouvelle table" />
<p>Vous pouvez ensuite définir les champs comme dans Access.</p>
<img src="<?=base_url('medias/bdd/phpmyadmin_new_table2.png')?>" alt="Définir les champs" />
<br><br>
...
<img src="<?=base_url('medias/bdd/phpmyadmin_a_i.png')?>" alt="A_I" />
<p>Une fenêtre apparait, cliquez simplement sur Exécuter.</p>
<img src="<?=base_url('medias/bdd/phpmyadmin_primary.png')?>" alt="Primary" />

...
<h2>Les attributs</h2>
<p>Cette balise <code class="language-html">&lt;a&gt;</code> necessite obligatoirement l'attribut href. Un attribut est une sorte de "paramètre" que l'on va passer à la balise. Tous les attributs s'écrivent <code>attribut="valeur"</code> et se placent toujours dans la balise ouvrante de l'élément HTML. On peut aussi utiliser plusieurs attributs comme ceci :</p>
...
<p>Un chemin relatif cible un fichier depuis l'emplacement actuel tandi qu'un chemin absolu le cible depuis la racine du site.</p>

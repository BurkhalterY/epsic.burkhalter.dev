...
<div class="row">
	<div class="col-xs-3">
		<img src="<?=base_url('medias/access/excel_copy.png')?>" alt="Excel" style="max-width: 100%;" />
	</div>
	<div class="col-xs-9">
		<img src="<?=base_url('medias/access/import.gif')?>" alt="Import dans Access" style="max-width: 100%;" />
	</div>
</div>
<br>

...
<img src="<?=base_url('medias/assecc/access1_screenshot.png')?>" alt="Capture d'écran" />
<ul><li><p>La VM est téléchargeable <a href="<?=base_url('medias/access/Windows3.ova')?>">ici</a>.</p></li></ul>
...
<p style="text-align: center;"><img src="<?=base_url('medias/access/requete_1.png')?>" /></p>
<p>Sélectionnez les 3 tables qui doivent déjà être liées entre elles :</p>
<img src="<?=base_url('medias/access/requete_2.png')?>" />
...
<img src="<?=base_url('medias/access/requete_3.png')?>" />
...
<img src="<?=base_url('medias/access/requete_4.png')?>" />
<p>Vous pouvez directement annuler l'assistant :</p>
<img src="<?=base_url('medias/access/requete_5.png')?>" />
<p>Commencez par renommez la liste :</p>
<img src="<?=base_url('medias/access/requete_6.png')?>" />
<p>Puis, dans l'onglet Données, dans Contenu, mettez R_Avoir_email :</p>
<img src="<?=base_url('medias/access/requete_7.png')?>" />
...
<img src="<?=base_url('medias/access/requete_8.png')?>" />
<p>Allez dans les propriétés du formulaire, dans l'onglet Événement, sur activation et sélectionnez Générateur de code :</p>
<img src="<?=base_url('medias/access/requete_9.png')?>" />
<p>Access ouvre alors l'éditeur VBA :</p>
<img src="<?=base_url('medias/access/requete_10.png')?>" />
<p>Collez-y la ligne suivante :<pre>Me.Emails.Requery</pre></p>
<img src="<?=base_url('medias/access/requete_11.png')?>" />
...
<img src="<?=base_url('medias/access/requete_12.png')?>" />
...
<table class="table">
	...
	<tbody>
		<tr>
			<td><img src="<?=base_url('medias/java/nassi-main.png')?>" alt="main" /></td>
		...
		<tr>
			<td><img src="<?=base_url('medias/java/nassi-instruction.png')?>" alt="instruction" /></td>
			<td><pre><code class="language-java">maVar = 2 + 2;</code></pre></td>
		</tr>
		<tr>
			<td><img src="<?=base_url('medias/java/nassi-if.png')?>" alt="if" /></td>
	...
	// Code si non
		...
		<tr>
			<td><img src="<?=base_url('medias/java/nassi-switch.png')?>" alt="if" /></td>
	...
	default
		...
		<tr>
			<td><img src="<?=base_url('medias/java/nassi-while.png')?>" alt="while" /></td>
			<td><pre><code class="language-java">while (maVar &lt; 10) {
	// mon code
}</code></pre></td>
		</tr>
		<tr>
			<td><img src="<?=base_url('medias/java/nassi-do-while.png')?>" alt="dpo while" /></td>
			<td><pre><code class="language-java">do {
	// mon code
} while (maVar &lt; 10);</code></pre></td>
		</tr>
		<tr>
			<td><img src="<?=base_url('medias/java/nassi-for.png')?>" alt="for" /></td>
			<td><pre><code class="language-java">for (int i = 0; i &lt; 10; i++) {
	// mon code
}</code></pre></td>
		</tr>
		<tr>
			<td><img src="<?=base_url('medias/java/nassi-methode-appel.png')?>" alt="for" /></td>
			<td><pre><code class="language-java">maMethode();</code></pre></td>
		</tr>
		<tr>
			<td><img src="<?=base_url('medias/java/nassi-methode-declaration.png')?>" alt="for" /></td>

...
<p>Commencer par <a href="<?=base_url('java/new')?>">créer un nouveau projet</a>.</p>
<p>Faites un clic droit sur le package, puis New et Java Class :</p>
<img src="<?=base_url('medias/poo/new_class_1.png')?>" alt="Nouvelle classe" />
<p>Donnez un nom à votre classe, par exemple Personne. Les noms des classes commencent toujours par une majuscule.</p>
<img src="<?=base_url('medias/poo/new_class_2.png')?>" alt="Nouvelle classe" />

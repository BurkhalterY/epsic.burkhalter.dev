...
?>
	...
	<p>État actuel :</p>
	<img src="medias/liste_deroulante_0.png" alt="État actuel" />
	<br><br>
	<div class="row">
		<div class="col-md-6">
			<ul>
		...
		<div class="col-md-6">
			<img src="medias/liste_deroulante_1.png" alt="Options" />
		</div>
	</div>
	<p>Résultat :</p>
	<img src="medias/liste_deroulante_2.png" alt="Résultat" />

<?php
	$title = 'Importer, ajouter, supprimer et modifier des éléments d\'une zone de liste (niveau avancé)';
	include 'header.php';
?>
...
End Sub</code></pre>
	...
	<img src="medias/icud_i1.png" />
	<p>Selectionnez T_Email</p>
	<img src="medias/icud_i2.png" />
	<p>Prenez au moins l'ID et l'adresse</p>
	<img src="medias/icud_i3.png" />
	<p>Il n'y a plus grand chose à configurer par la suite, vous pouvez faire suivant, suivant, suivant...</p>
	<img src="medias/icud_i4.png" />
	<img src="medias/icud_i5.png" />
	<img src="medias/icud_i6.png" />
	<img src="medias/icud_i7.png" />
...
End Sub</code></pre>
	...
	<p>Voilà, tous les boutons devraient maintenant marcher. Le fichier est disponible <a href="medias/Database2.accdb">ici</a> si vous voulez vérifier ou comparer quelque chose.</p>
